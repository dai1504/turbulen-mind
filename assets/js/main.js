...
window.ScrollEffects = function() {
    ...
    var hasParallaxCate = gsap.utils.toArray('.cate-item-bg');			
    hasParallaxCate.forEach(function(hParallaxCate) {
        var bgImageCate = hParallaxCate.querySelector("img");
        var bgVideoCate = hParallaxCate.querySelector("video");
        var parallaxCate = gsap.fromTo( [bgImageCate, bgVideoCate], {y: '-20%', scale:1.15}, {y: '20%', scale:1, duration: 1, ease:Linear.easeNone});		
        var parallaxSceneCate = ScrollTrigger.create({
            trigger: hParallaxCate,
            start: "top 100%",
            end: () => `+=${hParallaxCate.offsetHeight + window.innerHeight}`,
            animation: parallaxCate,
            scrub: true
        });
    });
    ...
    $(".anim-zoomin").each(function() {
      ...
      $(".anim-img").each(function() {
        ...
        // Add wrap <div>.
        $(this).wrap('<div class="anim-img-wrap"></div>');

        // Add overflow hidden.
        $(".anim-img-wrap").css({ "overflow": "hidden" })

        var $this = $(this);
        var $asiWrap = $this.parents(".anim-img-wrap");
...
if ($(".arrivals-section").length) {
    $(".arrivals-slide").each(function() {
        ...
        var swiperProduct = new Swiper($(this).find('.swiper')[0], {
            ...
            pagination: {
                el: $(this).find('.arrivals-pagination')[0],
                clickable: true,
                dynamicBullets: true,
                dynamicMainBullets: 2
            },
            ...
            navigation: {
                nextEl: $(this).find('.arrivals-nav-btn-next')[0],
                prevEl: $(this).find('.arrivals-nav-btn-prev')[0]
            },
...
if ($(".home-banner").length) {
    $(".home-banner").each(function() {
        ...
        var swiperBanner = new Swiper($(this).find('.swiper')[0], {
            slidesPerView: 1,
            spaceBetween: 40,
            speed: 2000,
            effect: 'fade',
            ...
            pagination: {
                el: $(this).find('.home-banner-pagination')[0],
                clickable: true,
                dynamicBullets: true,
                dynamicMainBullets: 2
            },
            ...
            navigation: {
                nextEl: $(this).find('.home-banner-nav-next')[0],
                prevEl: $(this).find('.home-banner-nav-prev')[0]
            },
...
if ($(".product-detail-section").length) {
    $(".product-detail-section").each(function() {
        var swiperProductThumb = new Swiper('.product-slide-img-thumb .swiper', {
            direction: "vertical",
            slidesPerView: 3,
            spaceBetween: 3,
            speed: 2000,
            ...
            pagination: {
                el: '.product-slide-img-thumb .swiper-pagination',
                clickable: true,
            },
        
            navigation: {
                nextEl: '.product-slide-img-thumb .swiper-button-next',
                prevEl: '.product-slide-img-thumb .swiper-button-prev'
            },
            
        })
        var swiperProductImg = new Swiper('.product-slide-img .swiper', {
            slidesPerView: 1,
            spaceBetween: 15,
            speed: 2000,
            ...
            pagination: {
                el: '.product-slide-img .swiper-pagination',
                clickable: true,
            },
        
            navigation: {
                nextEl: '.product-slide-img .swiper-button-next',
                prevEl: '.product-slide-img .swiper-button-prev'
            },
            thumbs: {
