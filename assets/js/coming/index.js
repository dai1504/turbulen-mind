...
, function(t, e, i) {
  ...
  function n(t) {
      ...
      (s || r) && t.deltaMode && (1 == t.deltaMode ? (s *= 40,
      r *= 40) : (s *= 800,
      r *= 800)),
      s && !e && (e = s < 1 ? -1 : 1),
      r && !i && (i = r < 1 ? -1 : 1),
  ...
  function v() {
      if (!w) {
          ...
          e) {
              ...
              (n = e[4] ? parseFloat(e[4]) : NaN) ? (e = /(?:Chrome\/(\d+\.\d+))/.exec(t),
              h = e && e[1] ? parseFloat(e[1]) : NaN) : h = NaN
          } else
              i = s = r = h = n = NaN;
          if (v) {
              if (v[1]) {
...
*/
  ...
  t.exports = function(t, e) {
      ...
      return !n && s && "wheel" === t && (n = document.implementation.hasFeature("Events.wheel", "3.0")),
      n
  }
}
, function(t, e, i) {
...
, function(t, e, i) {
  ...
  class f {
      ...
      getRenderList({scene: t, camera: e, frustumCull: i, sort: s}) {
          ...
          s) {
              ...
              r.forEach(r => {
                  ...
                  r.zDepth = 0,
                  0 === r.renderOrder && r.program.depthTest && e && (r.worldMatrix.getTranslation(p),
      ...
      render({scene: t, camera: e, target: i=null, update: s=!0, sort: r=!0, frustumCull: n=!0, clear: h}) {
          ...
          (h || this.autoClear && !1 !== h) && (!this.depth || i && !i.depth || (this.enable(this.gl.DEPTH_TEST),
          this.setDepthMask(!0)),
  ...
  class M extends Array {
      ...
      set(t, e, i, s) {
          return t.length ? this.copy(t) : (x(this, t, e, i, s),
          this.onChange(),
          this)
      }
      rotateX(t) {
      ...
      fromEuler(t) {
          return function(t, e, i="YXZ") {
              let s = Math.sin(.5 * e[0])
                ...
                , a = Math.sin(.5 * e[2])
                , o = Math.cos(.5 * e[2]);
              "XYZ" === i ? (t[0] = s * h * o + r * n * a,
              t[1] = r * n * o - s * h * a,
              t[2] = r * h * a + s * n * o,
              t[3] = r * h * o - s * n * a) : "YXZ" === i ? (t[0] = s * h * o + r * n * a,
              t[1] = r * n * o - s * h * a,
              t[2] = r * h * a - s * n * o,
              t[3] = r * h * o + s * n * a) : "ZXY" === i ? (t[0] = s * h * o - r * n * a,
              t[1] = r * n * o + s * h * a,
              t[2] = r * h * a + s * n * o,
              t[3] = r * h * o - s * n * a) : "ZYX" === i ? (t[0] = s * h * o - r * n * a,
              t[1] = r * n * o + s * h * a,
              t[2] = r * h * a - s * n * o,
              t[3] = r * h * o + s * n * a) : "YZX" === i ? (t[0] = s * h * o + r * n * a,
              t[1] = r * n * o + s * h * a,
              t[2] = r * h * a - s * n * o,
              t[3] = r * h * o - s * n * a) : "XZY" === i && (t[0] = s * h * o - r * n * a,
              t[1] = r * n * o - s * h * a,
              t[2] = r * h * a + s * n * o,
              t[3] = r * h * o + s * n * a)
          }(this, t, t.order),
      ...
      slerp(t, e) {
          return function(t, e, i, s) {
              let r, n, h, a, o, l = e[0], u = e[1], c = e[2], d = e[3], g = i[0], p = i[1], m = i[2], f = i[3];
              n = l * g + u * p + c * m + d * f,
              n < 0 && (n = -n,
              g = -g,
              p = -p,
  ...
  const S = function() {
      ...
      return function(e, i) {
          ...
          let r = 1 / s[0]
            ...
            , f = a + c + m
            , w = 0;
          return f > 0 ? (w = 2 * Math.sqrt(f + 1),
          e[3] = .25 * w,
          e[0] = (d - p) / w,
          e[1] = (g - l) / w,
          e[2] = (o - u) / w) : a > c && a > m ? (w = 2 * Math.sqrt(1 + a - c - m),
          e[3] = (d - p) / w,
          e[0] = .25 * w,
          e[1] = (o + u) / w,
          e[2] = (g + l) / w) : c > m ? (w = 2 * Math.sqrt(1 + c - a - m),
          e[3] = (g - l) / w,
          e[0] = (o + u) / w,
          e[1] = .25 * w,
          e[2] = (d + p) / w) : (w = 2 * Math.sqrt(1 + m - a - c),
          e[3] = (o - u) / w,
          e[0] = (g + l) / w,
          e[1] = (d + p) / w,
          e[2] = .25 * w),
  ...
  class T extends Array {
      constructor(t=1, e=0, i=0, s=0, r=0, n=1, h=0, a=0, o=0, l=0, u=1, c=0, d=0, g=0, p=0, m=1) {
          return super(t, e, i, s, r, n, h, a, o, l, u, c, d, g, p, m),
          this
      }
      get x() {
          return this[12]
      ...
      translate(t, e=this) {
          return function(t, e, i) {
              let s, r, n, h, a, o, l, u, c, d, g, p, m = i[0], f = i[1], w = i[2];
              e === t ? (t[12] = e[0] * m + e[4] * f + e[8] * w + e[12],
              t[13] = e[1] * m + e[5] * f + e[9] * w + e[13],
              t[14] = e[2] * m + e[6] * f + e[10] * w + e[14],
              t[15] = e[3] * m + e[7] * f + e[11] * w + e[15]) : (s = e[0],
              r = e[1],
              n = e[2],
              h = e[3],
              a = e[4],
      ...
      rotate(t, e, i=this) {
          return function(t, e, i, s) {
              let r, n, h, a, o, l, u, c, d, g, p, m, f, w, v, x, b, E, M, y, A, S, T, _, F = s[0], R = s[1], P = s[2], C = Math.hypot(F, R, P);
              Math.abs(C) < 1e-6 || (C = 1 / C,
              F *= C,
              R *= C,
              P *= C,
              r = Math.sin(i),
  ...
  class F extends Array {
      ...
      fromQuaternion(t, e=this.order) {
          return _.fromQuaternion(t),
          this.fromRotationMatrix(_, e)
      }
  }
  class R {
      constructor() {
  ...
  class I extends R {
      ...
      unproject(t) {
          return t.applyMatrix4(P.inverse(this.projectionMatrix)),
  ...
  class O {
      ...
      getPositionArray() {
          ...
          return t.data ? t.data : B ? void 0 : (console.warn("No position buffer data found to compute bounds"),
          B = !0)
      }
      ...
      update(t=0) {
          ...
          e) {
              ...
              this.image) {
                  ...
                  this.generateMipmaps && (this.gl.renderer.isWebgl2 || V(this.image.width) && V(this.image.height) ? this.gl.generateMipmap(this.target) : (this.generateMipmaps = !1,
  ...
  class Z {
      ...
      use({flipFaces: t=!1}={}) {
          ...
          this.uniformLocations.forEach( (t, i) => {
              let s = i.uniformName
                , r = this.uniforms[s];
              if (i.isStruct && (r = r[i.structProperty],
              s += "." + i.structProperty),
              i.isStructArray && (r = r[i.structIndex][i.structProperty],
  ...
  let K = 0;
  function J(t) {
      K > 100 || (console.warn(t),
      K++,
      K > 100 && console.warn("More than 100 program warnings - stopping logs."))
  }
  function tt(t, e, i) {
      let s = e[0]
        , r = e[1]
  ...
  class et extends Array {
      constructor(t=1, e=0, i=0, s=0, r=1, n=0, h=0, a=0, o=1) {
          return super(t, e, i, s, r, n, h, a, o),
          this
      }
  ...
  class rt {
      constructor(t, {width: e=t.canvas.width, height: i=t.canvas.height, target: s=t.FRAMEBUFFER, color: r=1, depth: n=!0, stencil: h=!1, depthTexture: a=!1, wrapS: o=t.CLAMP_TO_EDGE, wrapT: l=t.CLAMP_TO_EDGE, minFilter: u=t.LINEAR, magFilter: c=u, type: d=t.UNSIGNED_BYTE, format: g=t.RGBA, internalFormat: p=g, unpackAlignment: m, premultiplyAlpha: f}={}) {
          ...
          this.gl.framebufferTexture2D(this.target, this.gl.DEPTH_ATTACHMENT, this.gl.TEXTURE_2D, this.depthTexture.texture, 0)) : (n && !h && (this.depthBuffer = this.gl.createRenderbuffer(),
          this.gl.bindRenderbuffer(this.gl.RENDERBUFFER, this.depthBuffer),
          this.gl.renderbufferStorage(this.gl.RENDERBUFFER, this.gl.DEPTH_COMPONENT16, e, i),
          this.gl.framebufferRenderbuffer(this.target, this.gl.DEPTH_ATTACHMENT, this.gl.RENDERBUFFER, this.depthBuffer)),
          h && !n && (this.stencilBuffer = this.gl.createRenderbuffer(),
          this.gl.bindRenderbuffer(this.gl.RENDERBUFFER, this.stencilBuffer),
          this.gl.renderbufferStorage(this.gl.RENDERBUFFER, this.gl.STENCIL_INDEX8, e, i),
          this.gl.framebufferRenderbuffer(this.target, this.gl.STENCIL_ATTACHMENT, this.gl.RENDERBUFFER, this.stencilBuffer)),
          n && h && (this.depthStencilBuffer = this.gl.createRenderbuffer(),
  ...
  new ([class {
      ...
      createMedias() {
          ...
          this.medias = Array.from(this.mediasElements).map(t => new class {
              ...
              update(t, e) {
                  ...
                  "up" === e && this.isBefore && (this.extra -= this.height,
                  this.isBefore = !1,
                  this.isAfter = !1),
                  "down" === e && this.isAfter && (this.extra += this.height,
                  this.isBefore = !1,
                  this.isAfter = !1),
      ...
      update() {
          ...
          this.speed = 2) : this.scroll.current < this.scroll.last && (this.direction = "up",
          this.speed = -2),
      ...
      createMedias() {
          ...
          this.medias = Array.from(this.mediasElements).map(t => new class {
              ...
              update(t, e) {
                  ...
                  "down" === e && this.isBefore && (this.extra -= this.width,
                  this.isBefore = !1,
                  this.isAfter = !1),
                  "up" === e && this.isAfter && (this.extra += this.width,
                  this.isBefore = !1,
                  this.isAfter = !1),
  ...
  Array.from(mt).forEach(t => {
      ...
      e.onload = t => {
          ft += 1,
          ft === mt.length && (document.documentElement.classList.remove("loading"),
